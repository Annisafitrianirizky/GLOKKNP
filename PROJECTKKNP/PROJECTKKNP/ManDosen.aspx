<%@ Page Title="" Language="C#" MasterPageFile="~/Dash.Master" AutoEventWireup="true" CodeFile="ManDosen.aspx.cs" Inherits="ManDosen" UnobtrusiveValidationMode="None" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Manage Dosen</h1>
            <!--<a
            href="#"
        ...
        <form id="form1" runat="server">
            ...
            <asp:GridView ID="grc1" runat="server" CssClass="gridview-container" BackColor="White" BorderColor="#cccccc" BorderStyle="None" BorderWidth="1px" CellPadding="5" AutoGenerateColumns="false">
                <Columns>
                    <asp:BoundField HeaderText="ID" DataField="id_dosen" HeaderStyle-Width="50px" />
                    <asp:BoundField HeaderText="Nama Dosen" DataField="nama_dosen" HeaderStyle-Width="150px" />
                    ...
                    <asp:BoundField HeaderText="Email" DataField="email" HeaderStyle-Width="150px" />
