<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeFile="KKN.aspx.cs" Inherits="KKN" UnobtrusiveValidationMode="None" %>
            ...
            <form method="post" role="form" runat="server">
                <div class="row gy-4">
                    ...
                    <div class="text-center mt-4">
                        <asp:Button ID="btnSubmit" runat="server" Text=" Daftar" OnClick="btnSubmit_Click" CssClass="btn btn-outline-primary"  />
                    </div>
            </form>
