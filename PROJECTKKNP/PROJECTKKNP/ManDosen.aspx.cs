...
public partial class ManDosen : System.Web.UI.Page
{
    ...
    protected void txtsave_Click(object sender, EventArgs e)
    {
        try
        {
           ...
           " VALUES(@idDsn,@Nama,@Nidn,@Telp,@Email)";
            ...
            Page.ClientScript.RegisterStartupScript(this.GetType(), "alert", "window.alert('" + "Save Data Success " + "');window.location.href='ManDosen.aspx';", true);
        }
        catch (Exception ex)
        {
    ...
    protected void lnkdelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Page.ClientScript.RegisterStartupScript(this.GetType(), "alert", "window.alert('" + "Delete Data Success " + "');window.location.href='ManDosen.aspx';", true);
        }
        catch (Exception ex)
        {
            Response.Write(ex.Message.ToString());
