<%@ Page Title="" Language="C#" MasterPageFile="~/DashDos.Master" AutoEventWireup="true" CodeFile="DosKKN.aspx.cs" Inherits="DosKKN" %>
            ...
            <table>
                    ...
                    <td class="form-section">
                        <table>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <asp:DropDownList runat="server" ID="ddlNama" AutoPostBack="true" OnSelectedIndexChanged="ddlNama_SelectedIndexChanged"></asp:DropDownList>
                            ...
                            <tr>
                                <td>Kelas</td>
                                <td>:</td>
                                <td><asp:Label ID="lblKelas" runat="server" Text=""></asp:Label></td>
                            </tr>
                            <tr>
                                <td>Prodi</td>
                                <td>:</td>
                                <td><asp:Label ID="lblProdi" runat="server" Text=""></asp:Label></td>
                            </tr>
                            <tr>
                                <td>Dosen Pembimbing</td>
                                <td>:</td>
                                <td><asp:Label ID="lblDosen" runat="server" Text=""></asp:Label></td>
                            </tr>
                        </table>
                    </td>
                    <td class="form-section">
                ...
                <tr>
                    ...
                    <td colspan="3" class="style1 button-container">
                        <asp:Button ID="txtsave" Text="Save" runat="server" CssClass="btn btn-outline-primary btn-sm" onclick="txtsave_Click" />
                        <asp:Button ID="txtupdate" runat="server" Text="Update" CssClass="btn-update" onclick="txtupdate_Click" Visible="false" />
                    </td>
                </tr>
            </table>
        </div>
