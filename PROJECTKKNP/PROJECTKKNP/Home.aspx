...
<head runat="server">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Quattrocento:wght@400;700&family=Questrial&display=swap" rel="stylesheet" />
...
<body class="index-page">
    ...
    <!--<div class="topbar d-flex align-items-center">
        ...
        <div class="contact-info d-flex align-items-center">
            <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:kampus@global.ac.id">kampus@global.ac.id</a></i>
            <i class="bi bi-phone d-flex align-items-center ms-4"><span>(021) 5522727</span></i>
        </div>
        </div>
    </div>-->
    <!-- End Top Bar -->
    ...
    <div class="branding d-flex align-items-center">
        ...
        <a href="Home.aspx" class="logo d-flex align-items-center me-auto me-xl-0">
            <!-- Uncomment the line below if you also wish to use an image logo -->
            <!-- <img src="assets/img/logo.png" alt=""> -->
            <h1 class="sitename">GLOKKNP</h1>
        </a>
        
        <nav id="navmenu" class="navmenu">
            <ul>
                <li><a href="Home.aspx" class="active">Home<br /></a></li>
                <li><a href="#about">Tentang Kami</a></li>
                <li class="dropdown"><a href="#program"><span>Program</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                    <ul>
                    <li><a href="KKN.aspx">Kuliah Kerja Nyata</a></li>
                    <li><a href="KKP.aspx">Kuliah Kerja Praktek</a></li>
                    </ul>
                </li>
        ...
        <div class="navmenu">
            ...
            <ul>
                <li><a href="Nilai.aspx">Lihat Nilai</a></li>
    ...
    <section id="hero" class="hero section dark-background">
        ...
        <div class="row">
            ...
            <div class="d-flex mt-4" data-aos="fade-up" data-aos-delay="300">
                <a href="#syarat" class="cta-btn">Persyaratan</a>
            </div>
            </div>
    ...
    <!-- Menu Section -->
    <section id="syarat" class="menu section">
    ...
    <!-- Specials Section -->
    <section id="faq" class="specials section">
        ...
        <div class="row">
            ...
            <ul class="nav nav-tabs flex-column">
                <li class="nav-item">
                <a class="nav-link active show" data-bs-toggle="tab" href="#faq-tab-1">Perbedaan KKN dan KKP</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#faq-tab-2">Cara Mendaftar</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#faq-tab-3">Lama Durasi</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#faq-tab-4">Manfaat</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#faq-tab-5">Proses Penempatan</a>
                </li>
            </ul>
            </div>
            <div class="col-lg-9 mt-4 mt-lg-0">
            <div class="tab-content">
                <div class="tab-pane active show" id="faq-tab-1">
                <div class="row">
                ...
                <div class="tab-pane" id="faq-tab-2">
                <div class="row">
                    <div class="col-lg-8 details order-2 order-lg-1">
                ...
                <div class="tab-pane" id="faq-tab-3">
                <div class="row">
                    <div class="col-lg-8 details order-2 order-lg-1">
                ...
                <div class="tab-pane" id="faq-tab-4">
                <div class="row">
                    <div class="col-lg-8 details order-2 order-lg-1">
                ...
                <div class="tab-pane" id="faq-tab-5">
                <div class="row">
                    <div class="col-lg-8 details order-2 order-lg-1">
    ...
    <div class="container footer-top">
        ...
        <div class="col-lg-4 col-md-6 footer-about">
            ...
            <span class="sitename">GLOKKNP</span>
            </a>
            <div class="footer-contact pt-3">
            <p>Jl. Aria Santika No.43, Margasari, Kec. Karawaci, Kota Tangerang</p>
            <p>Banten 15113</p>
            <p class="mt-3"><strong>Jam Operasional:</strong> <span>08:00 - 22:00</span></p>
            <p><strong>Telepon:</strong> <span>(021) 5522727</span></p>
            <p><strong>Email:</strong> <span>kampus@global.ac.id</span></p>
            </div>
    ...
    <div class="container copyright text-center mt-4">
        <p>© <span>Copyright</span> <strong class="px-1 sitename">GLOKKNP</strong> <span>All Rights Reserved</span></p>
        <div class="credits">
        <!-- All the links in the footer should remain intact. -->
        <!-- You can delete the links only if you've purchased the pro version. -->
        <!-- Licensing information: https://bootstrapmade.com/license/ -->
        <!-- Purchase the pro version with working PHP/AJAX contact form: [buy-url] -->
        Designed by INEXFOLER</a>
        </div>
    </div>
